...
import { useCreateAdminSessionMutation } from '../../graphql/generated/graphql';
...
export default function SignIn(): JSX.Element {
  ...
  const [createSession, { loading }] = useCreateAdminSessionMutation();
  const handleSubmit = React.useCallback(
    async (data: IFormData) => {
      try {
        ...
        setToken(response.data?.createAdminSession.token || null);
      } catch (err) {
